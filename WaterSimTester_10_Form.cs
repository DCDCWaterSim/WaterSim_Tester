...
namespace WaterSim_Tester
{
    ...
    public partial class WaterSimTestForm : Form
    {
       ...
       // DataTable MapDataTable = null;
        ...
        dbTool.SQLServer MyServer = dbTool.SQLServer.stAccess; //dbTool.SQLServer.stPostgreSQL;
        ...
        public WaterSimTestForm()
        {
           ...
           // TablenameComboBoxes.Add(MapTableListComboBox);
            ...
            WaterSimManager_DB.SQLServer = MyServer;
       ...
       //-------------------------------------------------------------
        ...
        private bool OpenDB()
        {
            switch (MyServer)
            {
                case dbTool.SQLServer.stAccess:
                    {
                        if (openFileDialog1.ShowDialog() == DialogResult.OK)
                        {
                            try
                            {
                                WSim.DatabaseFilename = openFileDialog1.FileName;
                                WSDB_Open = true;
                ...
                case dbTool.SQLServer.stPostgreSQL:
                    {
